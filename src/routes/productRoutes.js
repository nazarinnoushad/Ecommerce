...
import { createProduct, deleteProduct, filterProduct, getAllProducts, productCount, productList, productPhoto, searchProduct, singleProduct, updateProduct } from '../controllers/productControllers.js'
